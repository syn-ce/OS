/**
 * The CustomGraph is used to construct a Graph representing the problem the Shunter has to solve (i.e. moving all
 * wagons from the parking-Rail to the train-Rail with as little movements as possible). The CustomGraph is a Graph in
...
public class CustomGraph {
    ...
    /**
     * Constructs a new CustomGraph.
     * @param wagons Values of wagons in correct order.
     * @param differentWagonValues Wagons, except all duplicates have been removed and the values have been ordered ascending.
    ...
    public CustomGraph(int[] wagons, int[] differentWagonValues, int[][] C_L_arrays, int[][] C_R_arrays) {
        ...
        dijkstra.calculateShortestPathsFromNode(LPNodes[0]);   // search will always start at LP1 (/first LP-Node)
    }
